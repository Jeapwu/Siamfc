    ...
    with torch.cuda.device(gpu_id):
        ...
        for epoch in range(config.epoch):
            ...
            for i, data in enumerate(tqdm(trainloader)):
                exemplar_imgs, exemplar_bboxes, instance_imgs, instance_bboxes = data
                exemplar_imgs_var, exemplar_bboxes_var, instance_imgs_var, instance_bboxes_var = Variable(exemplar_imgs.cuda()), Variable(exemplar_bboxes.cuda()),\
                        Variable(instance_imgs.cuda()), Variable(instance_bboxes.cuda())
                optimizer.zero_grad()
                outputs = model((exemplar_imgs_var, exemplar_bboxes_var, instance_imgs_var, instance_bboxes_var))
